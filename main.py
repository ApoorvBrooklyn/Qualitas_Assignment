...
def chat_interaction():
    ...
    if prompt := st.chat_input("What is the answer?", key="chat_1"):
...
def show_question():
    if st.session_state.current_question_index < len(st.session_state.questions):
        ...
        # Handle case when all questions have been answered
        ...
        if not st.session_state.conflict_resolution_mode:
            ...
            if check_for_conflicts(completed_json):
                ...
                if st.session_state.questions:
                    ...
                    st.write("No conflict questions generated. Please check your conflict detection logic.")
            else:
            ...
            if check_for_conflicts(completed_json):
                ...
                if st.session_state.questions:
                    ...
                    st.write("No new conflict questions generated. Please check your conflict detection logic.")
            else:
                finalize_questionnaire(completed_json)
